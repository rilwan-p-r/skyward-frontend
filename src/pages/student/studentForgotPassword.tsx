...
import {changeStudentPassword, studentForgotPassword, studentVerifyOtp } from "../../api/student/studentForgotPassword";
...
export function StudentForgotPassword() {
    ...
    const emailFormik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                const response = await studentForgotPassword(values);
    ...
    const otpFormik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                const verifyOtpRes = await studentVerifyOtp(
                    {
    ...
    const passwordFormik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                const changePasswordResponse = await changeStudentPassword(
                    {email:emailFormik.values.email,
