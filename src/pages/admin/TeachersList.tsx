...
const TeachersList = () => {
  return (
    <>
      <div className="flex">
      <AdminSidebar />
      <div className="flex flex-col min-h-screen p-4 lg:p-10 flex-grow">
        <div className="flex flex-col w-full max-w-4xl p-4 lg:p-10 bg-white rounded shadow-md mx-auto mt-10 lg:mt-0">
